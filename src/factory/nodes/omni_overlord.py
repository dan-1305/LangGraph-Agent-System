...
class OmniOverlord(BaseAgent):
    def __init__(self):
        super().__init__(name="OmniOverlord", role="Supreme System Commander", agent_label="tier-1")
    ...
    def _ai_handler(self, *args, **kwargs) -> dict:
        """Bắt buộc triển khai từ BaseAgent."""
        return {}

    def _logic_handler(self, *args, **kwargs) -> dict:
        """Bắt buộc triển khai từ BaseAgent."""
        return {}
