...
with st.sidebar:
    ...
    user_image_prompt = st.checkbox("Sinh Image Prompts (Vẽ Avatar)", value=False, help="Tự động tạo các đoạn text mô tả ngoại hình nhân vật để ném vào Midjourney/Stable Diffusion.")
