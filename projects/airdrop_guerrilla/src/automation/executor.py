...
# Đảm bảo import được cả thư viện cục bộ và core của Monorepo
base_dir = Path(__file__).resolve().parent.parent.parent
if str(base_dir) not in sys.path:
    sys.path.append(str(base_dir))

# Đường dẫn root của Monorepo
...
class AirdropExecutor(BaseAgent):
    """
    ...
    def __init__(self, action_plan_path: str, wallet_manager: WalletManager, notifier: TelegramNotifier):
        # Khởi tạo BaseAgent với label tier-2
        super().__init__(name="AirdropExecutor", role="On-chain Automation Officer", agent_label="tier-2")
    ...
    def _verify_login_status(self, page, context, platform: str, wallet_address: str) -> bool:
        ...
        try:
            ...
            print(f"   ⚠️ Hết 15 giây vẫn không thấy dấu hiệu đăng nhập của {platform}.")
            return False
        return False
    ...
    def _discord_join(self, page, context, invite_url: str, wallet_address: str):
        ...
        try:
            ...
            print("   ⚠️ Không tìm thấy nút Accept Invite.")
...
if __name__ == "__main__":
    ...
    print("Executor initialized with BaseAgent compliance.")
