...
def home() -> str:
    ...
    """
    model_loaded = (model_high_end is not None) and (model_mass_market is not None)
    return render_template('index.html', provinces=provinces, districts=districts, model_loaded=model_loaded)
...
def show_map() -> str:
    ...
    try:
        ...
        district_coords = {
            ...
            'Phường Trấn Biên': [10.9634, 106.8222],
            'Phường Long Bình': [10.9412, 106.8643],
            'Phường Phước Tân': [10.9022, 106.8643],
            'Phường Trảng Dài': [10.9856, 106.8653],
            'Phường Tân Triều': [10.9675, 106.7981],
            'Phường Biên Hòa': [10.9575, 106.8427],
            'Phường Tam Hiệp': [10.9482, 106.8451],
            'Xã Trảng Bom': [10.9511, 107.0142],
            'Phường Long Thành': [10.6865, 106.9458],
            'Xã Xuân Lộc': [10.8354, 107.2435],
            'Phường Long Hưng': [10.9015, 106.8251],
            'Xã Xuân Quế': [10.8654, 107.1234],
            'Xã Phước An': [10.7451, 106.9612],
            'Xã Cẩm Mỹ': [10.8242, 107.1512],
            'Phường Bảo Vinh': [10.9581, 107.2501],
            'Xã An Phước': [10.7812, 106.9531],
            'Phường Dầu Giây': [10.9611, 107.1122],
            'Xã Bình Minh': [10.9654, 106.9951],
            'Phường Long Khánh': [10.9381, 107.2403],
            'Phường Tân Phú': [11.2335, 107.4192]
        }
