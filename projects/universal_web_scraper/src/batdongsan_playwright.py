...
class BatDongSanPlaywrightScraper:
    ...
    def run_guerrilla(self, max_pages=500, batch_size=2):
        ...
        try:
            ...
            print(f"❌ Lỗi khởi tạo Playwright: {e}")
            import traceback
            traceback.print_exc()
            return
