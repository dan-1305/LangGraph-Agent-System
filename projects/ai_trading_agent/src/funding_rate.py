...
class FundingRateMonitor(BaseAgent):
    """
    ...
    def get_funding_rates(self, symbol: str = "BTC") -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"⚠️ Coinglass API lỗi {response.status_code}, đang chuyển sang Binance Fallback...")
                return None
                
        except requests.exceptions.Timeout:
            print("⚠️ Coinglass API timeout, đang chuyển sang Binance Fallback...")
            return None
        except Exception as e:
            print(f"⚠️ Lỗi Coinglass ({e}), đang chuyển sang Binance Fallback...")
            return None
    ...
    def get_avg_funding_rate(self, symbol: str = "BTC") -> Dict[str, float]:
        ...
        if df is None or df.empty:
            ...
            try:
                ...
                resp = HTTPClient.get(binance_url, timeout=5)
