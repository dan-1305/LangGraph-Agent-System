...
# Thêm base_dir vào sys.path để import config chuẩn
...
class FundamentalAnalyzer(BaseAgent):
    ...
    Kế thừa BaseAgent để quản trị rủi ro và giám sát tiến trình.
    """
    
    def __init__(self):
        super().__init__(name="FundamentalAnalyzer", role="Value Investment Expert", agent_label="tier-2")
    ...
    def generate_fundamental_report(self, tickers: List[str] = Config.TRADE_TICKERS) -> str:
        """
