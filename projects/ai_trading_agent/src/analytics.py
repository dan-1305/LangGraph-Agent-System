...
# Thêm base_dir vào sys.path để import BaseAgent
...
class Analytics(BaseAgent):
    ...
    Kế thừa BaseAgent để đồng bộ chuẩn Monorepo.
    """
    
    def __init__(self):
        super().__init__(name="TradingAnalytics", role="Performance Monitor", agent_label="tier-2")
